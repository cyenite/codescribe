 ...
 */
class SchoolCurriculumCreatorTest : GenerationReportBase<SchoolCurriculumCreatorTest.SchoolCurriculumCreator>(SchoolCurriculumCreator::class) {
    ...
    fun testSchoolCurriculumCreator() {
        runReport("SchoolCurriculumCreator") { api, logJson, out ->
