...
class DocGen {
    ...
    fun plugin_xml() {
        ...
        printTable2(
            writer,
            actions.filter { it["id"].toString().startsWith("com.github.cyenite.codescribe.actions.generic") }
                .toTypedArray())
        ...
        printTable2(
            writer,
            actions.filter { it["id"].toString().startsWith("com.github.cyenite.codescribe.actions.code") }
                .toTypedArray())
        ...
        printTable2(
            writer,
            actions.filter { it["id"].toString().startsWith("com.github.cyenite.codescribe.actions.markdown") }
                .toTypedArray())
        ...
        printTable2(
            writer,
            actions.filter { it["id"].toString().startsWith("com.github.cyenite.codescribe.actions.dev") }
                .toTypedArray())
